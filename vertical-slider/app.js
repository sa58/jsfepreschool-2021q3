console.log(`1. 10/10 - вертикальный слайдер присутствует, в рабочем состоянии
2. 8/10 - слайдер зациклен, но при масштабированиии проблемы с отображением
3. 8/10 - реализовано пролистывание слайдера колёсиком мышки (объективно улучшение небольшое)`)
